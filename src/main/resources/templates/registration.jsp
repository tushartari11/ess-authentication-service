...
<div class="container">
    <div class="row main">
        ...
        <div class="main-login main-center">
            <!--/*--><!--@thymesVar id="user" type="de.vitapublic.essAuthenticationService.model.User"--><!--*/-->
            <form class="form-horizontal" action="#" th:action="@{/registration}" th:object="${user}" method="post" >

                <div th:if="${#fields.hasErrors('*')}" class="alert alert-danger fade in">
                ...
                <div class="form-group ${status.error ? 'has-error' : ''}">
                    ...
                    <div class="cols-sm-10">
                        <div class="input-group">
                            ...
                            <input type="text" th:field="*{username}" class="form-control" name="username" id="username"  placeholder="Enter your Username"/>
                        </div>
                    </div>
                </div>
